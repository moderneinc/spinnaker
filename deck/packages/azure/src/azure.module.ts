...
import { AZURE_PIPELINE_STAGES_FINDIMAGEFROMTAGS_AZUREFINDIMAGEFROMTAGSSTAGE } from './pipeline/stages/findImageFromTags/azureFindImageFromTagsStage';
import { AZURE_PIPELINE_STAGES_RESIZEASG_AZURERESIZEASGSTAGE } from './pipeline/stages/resizeAsg/azureResizeAsgStage';
import { AZURE_PIPELINE_STAGES_SHRINKCLUSTER_AZURESHRINKCLUSTERSTAGE } from './pipeline/stages/shrinkCluster/azureShrinkClusterStage';
import { AZURE_PIPELINE_STAGES_TAGIMAGE_AZURETAGIMAGESTAGE } from './pipeline/stages/tagImage/azureTagImageStage';
...
module(AZURE_MODULE, [
  ...
  AZURE_PIPELINE_STAGES_FINDIMAGEFROMTAGS_AZUREFINDIMAGEFROMTAGSSTAGE,
  AZURE_PIPELINE_STAGES_RESIZEASG_AZURERESIZEASGSTAGE,
  AZURE_PIPELINE_STAGES_SHRINKCLUSTER_AZURESHRINKCLUSTERSTAGE,
  AZURE_PIPELINE_STAGES_BAKE_AZUREBAKESTAGE,
  AZURE_PIPELINE_STAGES_TAGIMAGE_AZURETAGIMAGESTAGE,
